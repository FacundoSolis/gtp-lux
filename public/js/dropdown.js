document.addEventListener('DOMContentLoaded', function () {
    ...
    dropdownValue.addEventListener('click', function (event) {
        ...
        const isDropdownOpen = languageDropdown.style.display === 'flex'; // Cambia 'block' a 'flex'
        languageDropdown.style.display = isDropdownOpen ? 'none' : 'flex'; // Cambia 'block' a 'flex'
    });
